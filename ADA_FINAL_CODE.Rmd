...
# Check variable classes and clean data
```{r}
# check classes
...
# variables need to be factor variables (except for MENTHLTH)
...
table(brfss20_SCD$age)
```

# Make a subset of the data based on age since only those 45 and over are eligible for SCD screening question
```{r}
